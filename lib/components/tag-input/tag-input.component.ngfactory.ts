...
import * as import0 from '../../../components/tag-input/tag-input.component';
...
import * as import12 from '../../../components/tag-input-item/tag-input-item.component';
import * as import13 from '../tag-input-item/tag-input-item.component.ngfactory';
import * as import14 from '@angular/core/src/linker/view_container';
import * as import15 from '../../../components/tag-input-autocomplete/tag-input-autocomplete.component';
import * as import16 from '../tag-input-autocomplete/tag-input-autocomplete.component.ngfactory';
...
export class Wrapper_TagInputComponent {
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean,emit2:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.currentTag.subscribe(_eventHandler.bind(view,'currentTag'))); }
    if (emit1) { (this.subscription1 = this.context.addTag.subscribe(_eventHandler.bind(view,'addTag'))); }
    if (emit2) { (this.subscription2 = this.context.removeTag.subscribe(_eventHandler.bind(view,'removeTag'))); }
  }
}
...
class View_TagInputComponent_Host0 extends import2.AppView<any> {
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TagInputComponent_Host0,renderType_TagInputComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._TagInputComponent_0_3 = new Wrapper_TagInputComponent(this.injectorGet(import9.FormBuilder,this.parentIndex),new import10.ElementRef(this._el_0));
    ...
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TagInputComponent_0_3.context);
  }
...
export const TagInputComponentNgFactory:import8.ComponentFactory<import0.TagInputComponent> = new import8.ComponentFactory<import0.TagInputComponent>('rl-tag-input',View_TagInputComponent_Host0,import0.TagInputComponent);
...
class View_TagInputComponent1 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import12.TagInputItemComponent>;
  _TagInputItemComponent_0_3:import13.Wrapper_TagInputItemComponent;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import14.ViewContainer) {
    super(View_TagInputComponent1,renderType_TagInputComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this.compView_0 = new import13.View_TagInputItemComponent0(this.viewUtils,this,0,this._el_0);
    this._TagInputItemComponent_0_3 = new import13.Wrapper_TagInputItemComponent();
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import12.TagInputItemComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._TagInputItemComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class View_TagInputComponent2 extends import2.AppView<any> {
  ...
  _text_1:any;
  _el_2:any;
  compView_2:import2.AppView<import15.TagInputAutocompleteComponent>;
  _TagInputAutocompleteComponent_2_3:import16.Wrapper_TagInputAutocompleteComponent;
  _text_3:any;
  _text_4:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import14.ViewContainer) {
    super(View_TagInputComponent2,renderType_TagInputComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this.compView_2 = new import16.View_TagInputAutocompleteComponent0(this.viewUtils,this,2,this._el_2);
    this._TagInputAutocompleteComponent_2_3 = new import16.Wrapper_TagInputAutocompleteComponent(new import10.ElementRef(this._el_2));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import15.TagInputAutocompleteComponent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._TagInputAutocompleteComponent_2_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export class View_TagInputComponent0 extends import2.AppView<import0.TagInputComponent> {
  _viewQuery_tagInputElement_0:import17.QueryList<any>;
  _text_0:any;
  _anchor_1:any;
  ...
  _text_4:any;
  _el_5:any;
  _DefaultValueAccessor_5_3:import21.Wrapper_DefaultValueAccessor;
  _NG_VALUE_ACCESSOR_5_4:any[];
  _FormControlName_5_5:import22.Wrapper_FormControlName;
  _NgControl_5_6:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TagInputComponent0,renderType_TagInputComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
    this._expr_25 = import1.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._viewQuery_tagInputElement_0 = new import17.QueryList<any>();
    ...
    this._NgFor_1_6 = new import18.Wrapper_NgFor(this._vc_1.vcRef,this._TemplateRef_1_5,this.parentView.injectorGet(import25.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._DefaultValueAccessor_5_3 = new import21.Wrapper_DefaultValueAccessor(this.renderer,new import10.ElementRef(this._el_5));
    this._NG_VALUE_ACCESSOR_5_4 = [this._DefaultValueAccessor_5_3.context];
    this._FormControlName_5_5 = new import22.Wrapper_FormControlName(this._ControlContainer_3_4,(null as any),(null as any),this._NG_VALUE_ACCESSOR_5_4);
    ...
    this._viewQuery_tagInputElement_0.reset([new import10.ElementRef(this._el_5)]);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import26.NgFor) && (1 === requestNodeIndex))) { return this._NgFor_1_6.context; }
    if (((token === import27.DefaultValueAccessor) && (5 === requestNodeIndex))) { return this._DefaultValueAccessor_5_3.context; }
    if (((token === import11.NG_VALUE_ACCESSOR) && (5 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_5_4; }
    if (((token === import28.FormControlName) && (5 === requestNodeIndex))) { return this._FormControlName_5_5.context; }
    ...
    if (((token === import32.FormGroupDirective) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._FormGroupDirective_3_3.context; }
    if (((token === import33.ControlContainer) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._ControlContainer_3_4; }
    if (((token === import30.NgControlStatusGroup) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._NgControlStatusGroup_3_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
